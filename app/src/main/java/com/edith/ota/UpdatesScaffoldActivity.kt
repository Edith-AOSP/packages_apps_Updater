...
import com.edith.ota.controller.UpdaterController
...
import com.edith.ota.updates.state.UpdateItemStateMapper
import com.edith.ota.updatescheck.UpdatesCheckState
import com.edith.ota.updatescheck.rememberUpdatesCheckUiState
...
private fun UpdatesScaffoldContent(
    ...
    if (DeviceInfoUtils.isDebugUpdaterEnabled && showDebug) {
    ...
    SystemUpdateScreen(
        ...
        onDebugClick = if (DeviceInfoUtils.isDebugUpdaterEnabled) ({ showDebug = true }) else null,
    )
}
